...
public class ConfiguracaoSpringMvc implements WebMvcConfigurer {
     ...
     * controller automático, definido pelo próprio Spring, para atender a
     * requisições direcionadas à URL / e /home. E com a chamada a
     * setViewName(), sempre que a aplicação receber uma requisição para um
     * desses endereços, a view home, criada na última aula, será exibida.
     *
     * @param registry
     */
    @Override
    public void addViewControllers(ViewControllerRegistry registry) {
        registry.addViewController("/").setViewName("venda/index");
